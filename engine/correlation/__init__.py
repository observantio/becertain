"""
Correlation logic for identifying related anomalies across different signals (metrics, logs, traces) based on temporal proximity and other heuristics, to assist in root cause analysis and incident investigation.

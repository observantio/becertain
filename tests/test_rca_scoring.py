"""
Test cases for scoring logic in the RCA component of the analysis engine, including relevance scoring of root cause candidates based on signal strength, temporal proximity, and category-specific heuristics.
...
def _event(metric_names: list[str], latency_services: list[str] | None = None, confidence: float = 0.8) -> CorrelatedEvent:
